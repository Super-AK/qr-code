...
// Label checkbox toggle + real-time updates
document.getElementById('labelTopEnable').addEventListener('change', function() { updateLabels(); });
document.getElementById('labelBottomEnable').addEventListener('change', function() { updateLabels(); });
document.getElementById('labelTopText').addEventListener('input', function() { updateLabels(); });
document.getElementById('labelBottomText').addEventListener('input', function() { updateLabels(); });
document.getElementById('labelSize').addEventListener('input', function() { updateLabels(); });
document.getElementById('labelColor').addEventListener('input', function() { updateLabels(); });
document.getElementById('labelBold').addEventListener('change', function() { updateLabels(); });
